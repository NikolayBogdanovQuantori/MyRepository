...
-- MAGIC 
-- MAGIC # если бы использовалась дефолтная БД, то расположение было бы следующим:
-- MAGIC # dbfs:/user/hive/warehouse/dbacademy_nikolay_bogdanov_quantori_com_dewd_3_3l.db/weather_managed
